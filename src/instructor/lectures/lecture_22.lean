...
/-
Congruence mod n is reflexive by the reflexivity of
equality because the mod relation is based on equality.
Congruence mod n is symmetric by the symmetry of equality
because the mod relation is based on equality. Also
